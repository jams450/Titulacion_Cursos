...
update cursos set resumen="Descubre cómo manejar de manera efectiva tu Tarjeta de Débito sin importar el Banco al que pertenezcas" where idcurso=1;
update cursos set resumen="Descubre cómo manejar de manera efectiva tu Tarjeta de Crédito sin importar el Banco al que pertenezcas" where idcurso=2;
update cursos set resumen="¿Sabes qué es una Cuenta de Ahorro y los beneficios que ésta conlleva? ¡Descúbrelo con este curso!" where idcurso=3;
update cursos set resumen="¿Te conviene tener una Cuenta de Inversión? Decídelo por ti mismo a través de este curso" where idcurso=4;
update cursos set resumen="Planificar a futuro es fundamental. Descubre más sobre el Ahorro para el Retiro aquí" where idcurso=5;
update cursos set resumen="De vida, de auto, de casa,... ¿Te conviene contratar un seguro?" where idcurso=6;
update cursos set resumen="Descubre en qué te beneficia un Crédito Automotriz por medio de este curso" where idcurso=7;
