	...
	<body>
      ...
      <section>
		<div class="block gray ">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="how-it-works"><a href="/view/registro_usuario.php">
							<div class="work-icon"> <img src="/view/images/usuario.png" width="100" height="100" alt="" /> </div>
						...
						<div class="how-it-works"><a href="/view/registro_usuario.php">
							<div class="work-icon"> <img src="/view/images/cursos.png" width="100" height="100" alt="" /> </div>
							<div class="work-detail">
								<h3>Cursos</h3>
						...
						<div class="how-it-works"><a href="/view/registro_usuario.php">
							<div class="work-icon"> <img src="/view/images/miscursos.png" width="100" height="100" alt="" /> </div>
							<div class="work-detail">
								<h3>Mis Cursos</h3>
            ...
            <div class="how-it-works"><a href="/view/registro_usuario.php">
							<div class="work-icon"> <img src="/view/images/gastos.png" width="100" height="100" alt="" /> </div>
							<div class="work-detail">
								<h3>Mis Gastos</h3>
            ...
            <div class="how-it-works">
							<div class="work-icon"> <img src="/view/images/cerrarsesion.png" width="100" height="100" alt="" /> </div>
							<div class="work-detail">
								<h3>Cerrar Sesión</h3>
