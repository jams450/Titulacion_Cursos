...
<script>
    $( document ).ready(function(){
        $.ajax({
            data: {
                "getListQuestionsForAnfitrion" : "getListQuestionsForAnfitrion",
                "idan" : <?=$_GET['idan']?>
            },
            type: "POST",
            dataType: "json",
            ...
            .done(function( data ) {
                ...
                data.data.forEach(element => {
                    ...
                    var div = '<div class="how-it-works">\n' +
                        ...
                        '<p>Revisa las preguntas que tienen para tí en esta actividad <a href="'+window.location.origin+'/view/anfitrion/chat.php?id_qa='+element.id_qa+'" > aqui </a></p>\n' +
                        '</div>\n' +
                        '</div>';
                    $('#itemRows').append(div);
                });
