							...
							<div class="row">
								<div class="list-detail-box" id="foto_portada">
									<div class="list-detail-info">
										...
										<a href="#" title="" class="write-review">Pagada</a>
									</div>
								</div>
							</div>
						</div>
...
<script>
		$( document ).ready(function(){
				$.ajax({
						data: {
								"detalleActividadHistorial" : "detalletActividad",
                                "ia" : <?= $_GET['ida'] ?>,
                                "dpa" : <?= $_GET['iddp'] ?>,
                                "pa": <?= $_GET['idpa'] ?>,
                                "idr": <?=$_GET['idr']?>,
				...
				.done(function( data ) {
						...
						data.actividades.data[0].tipoImagengaleria.forEach(element => {
							...
							var div = '<div class="col-md-6"><a class="img-responsive img-thumbnail" width="100px" height="90px" href="'+path+'" title=""><img src="'+path+'" alt="" /></a></div>';
						...
						var info = '<span><i class="la la-cog"></i>Tipo: '+data.actividades.data[0].tipo_actividad+'</span>';
