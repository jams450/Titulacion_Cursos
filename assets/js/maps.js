$(document).on('ready', function(){
	...
	// Define Marker properties
	var image2 = new google.maps.MarkerImage('/assets/images/marker2.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
	...
	// Define Marker properties
	var image3 = new google.maps.MarkerImage('/assets/images/marker3.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(0, 42)
	);
	...
	// Define Marker properties
	var image4 = new google.maps.MarkerImage('/assets/images/marker4.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(0, 42)
	);
	...
	// Define Marker properties
	var image5 = new google.maps.MarkerImage('/assets/images/marker2.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(0, 42)
	);
	...
	// Define Marker properties
	var image6 = new google.maps.MarkerImage('/assets/images/marker1.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(0, 42)
	);
	...
	// Define Marker properties
	var image7 = new google.maps.MarkerImage('/assets/images/marker4.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(18, 42)
	);
	...
	// Define Marker properties
	var image8 = new google.maps.MarkerImage('/assets/images/marker3.png',
		new google.maps.Size(46, 57),
		new google.maps.Point(0,0),
		new google.maps.Point(18, 42)
	);
